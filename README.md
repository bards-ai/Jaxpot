...
<img src="public/dark_hex_720_at_20.gif" width="720" alt="Jaxpot dark hex self-play demo" />
...
Tic-Tac-Toe observations have shape `(3, 3, 2)` → flattened input dim `18`, with `9` discrete actions. A tiny MLP is more than enough. Create config for the model:
