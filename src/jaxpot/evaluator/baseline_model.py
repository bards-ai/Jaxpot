...
class BaselineModelPpoEvaluator(BaseEvaluator):
    """Evaluate the current model with PPOActor against a fixed baseline opponent."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.include_elo = include_elo
        self.no_auto_reset_step_fn = no_auto_reset_step_fn
        self.actor = PolicyActor(model=baseline_model).setup(
